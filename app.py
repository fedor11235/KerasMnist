...
# Скачиваем стандартный датасет керас
...
# Нормализируем для быстрой тренировки сети
...
# Тестируем нейросеть на других данных и выводим предсказания
test_loss, test_acc = model.evaluate(test_images,  test_labels, verbose=2)
print('\nТочность на проверочных данных:', test_acc)


# Показываем насколько ошибласть сеть
